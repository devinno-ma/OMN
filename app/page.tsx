...
export default function Home() {
  ...
  const testimonials = [
    {
      text: "Oh! My Nails is where artistry meets perfection. Every design is a masterpiece.",
      author: "Sara M.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden md:pt-10 md:pb-10 pt-5 text-center pb-10">
        ...
        <div className="absolute top-0 right-0 w-96 bg-gradient-to-br from-red-lightest via-red-lighter to-transparent rounded-full blur-3xl opacity-60 animate-float h-96 my-1.5 text-center" />
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              {/* Badge */}
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-red-lightest rounded-full border border-red-light/50 animate-fade-in text-justify">
              ...
              <div className="space-y-4">
                <h1 className="luxury-text md:text-7xl leading-tight text-5xl text-center lg:text-6xl">
                  Elevate Your
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary via-red-medium to-primary animate-pulse">
                    Nail Game
                  </span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 text-center items-stretch mx-12">
                ...
                <Link
                  href="/services"
                  className="px-8 py-4 border-2 border-primary text-primary rounded-full font-semibold hover:bg-red-lightest transition-all duration-300 inline-flex items-center justify-center"
                >
                  Our Services
                </Link>
              </div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-red-lighter/10 to-transparent rounded-3xl blur-2xl" />
              <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollAnimation className="space-y-6">
              <div>
                <p className="text-primary font-serif text-lg mb-3">About Oh! My Nails</p>
                ...
                <p className="leading-relaxed text-foreground text-sm">
                  At Oh! My Nails, we believe nail art is an expression of your personality. For over a decade, we've
                  been creating stunning nail designs that celebrate individuality and style. Our team of expert nail
      ...
      <section className="bg-gradient-to-b from-red-lightest/30 to-background md:py-10 py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation>
            ...
            {services.map((service, index) => (
              <ScrollAnimation key={index} className="h-full">
                ...
                >
                  ...
                  {/* Accent line */}
                  <div className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-primary to-red-medium group-hover:w-full transition-all duration-500" />
                </div>
              </ScrollAnimation>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-4">
          <ScrollAnimation>
            <div className="text-center mb-20">
              ...
              <p className="text-lg max-w-2xl mx-auto leading-relaxed text-foreground">
                Discover the transformations and joy our clients experience at Oh! My Nails.
              </p>
            </div>
          </ScrollAnimation>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <ScrollAnimation key={index}>
                <div
                  className="group relative bg-gradient-to-br from-white to-red-lightest/50 rounded-2xl p-8 luxury-shadow hover:luxury-shadow-lg transition-all duration-500 hover:-translate-y-2 border border-red-light/30"
                  style={{ animationDelay: `${index * 150}ms` }}
                >
                  {/* Star rating */}
                  ...
                  {/* Quote */}
                  <p className="text-foreground mb-8 italic leading-relaxed font-light text-base">"{testimonial.text}"</p>

                  {/* Author */}
                  <div className="flex items-center gap-4 pt-6 border-t border-red-light/30">
                    <img
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <ScrollAnimation>
            ...
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed">
              Step into Oh! My Nails and discover stunning nail art that makes you feel confident and beautiful.
            </p>
            <Link
              href="/booking"
